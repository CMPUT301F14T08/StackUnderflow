...
/**
 * MainActivity is the main page. Called when the user first starts the app works with the tabs on
 * the main screen and the dialog allowing the user to navigate between the different screens.
 * 
...
public class MainActivity extends Activity implements TabListener {
    ...
    /**
     * Called when the activity is first create. This is used to create the menu bar for sorting a
     * posts by newest and most popular.
     */
    ...
    /**
     * case statements of what to do when a option from the menu is selected. Ask question make a
     * new intent of NewQuestionActivity and inflates it User Profile creates a new intent of User
     * Profile and inflates it Search makes opens a fragment manager and gives a pop up block to
     * allow the user to search default. If none of the above options are select it will say that
     * there is a unimplemented method. This should not be seen unless there is a bug. This is
     * simply a safety to prevent the app from crashing if such a bug was to occure.
     */
    @Override
        ...
        if (requestCode == PICK_QUESTION) {
            if (resultCode == RESULT_OK) {
                ...
                if (data.getByteArrayExtra("question.picture") != null) {
                    ...
                    picture = Base64.encodeToString(data.getByteArrayExtra("question.picture"),
                            Base64.DEFAULT);
                }
