...
/**
 * Shows then the map so users will be able to view the map. When they click on the map they will
 * drop a pointer that will denote their location.
 * 
...
public class MapActivity extends Activity {
    ...
    public void errorToast(String errorText) {
        ...
        toast.setGravity(Gravity.BOTTOM, 0, findViewById(R.id.map_fragment_buttons_layout)
                .getHeight() + 5);
        toast.show();
    }
}
