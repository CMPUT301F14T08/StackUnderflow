...
/**
 * StackUnderflow application PostController. Point of access for post manager - handles differences
 * between online/cached post manager automatically. Determines whether to provide online or cache
 * manager based on online/offline status.
 * 
...
public class PostController {
    ...
    private PostController(Context context) {
        // Checks if the user is connected to the Internet it will use the online post manager
        // otherwise it
        // will use a cached post manger that will later be pushed online when the user enters a
        // network.
        mContext = context;
    ...
    /**
     * retrieves the post controller or initializes it if it doesn't exits pushes offline updates
     * online (singleton)
     * 
    ...
    /**
     * Static initializer, use this to get the active instance if you're just concerned with
     ...
     * 
     * @param Context is the current context of the app
     * @param postUUID the randomly generated UUID of the post you are looking to get the instance
     *            of
    ...
    /**
     * Given a answer/reply/or question returns the question related to the object For example,
     * given an answer - returns answer's the parent question given an answer reply - returns the
     * answer's parent question
     * 
     * @param object can be a post question or answer and it will try to find the related question
     *            to it
    ...
    /**
     * Type Checking -- Use this to tell if we're online or offline
     * 
     * @return false if there is an instance of mPostManager in CachedPostedManager otherwise
     *         returns false.
     */
