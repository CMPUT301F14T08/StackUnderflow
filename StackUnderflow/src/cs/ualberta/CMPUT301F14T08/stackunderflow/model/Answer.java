...
/**
 * Answer class, extends Post class. Used to hold answers to questions. mPartent ID will like an
 * answer to a question. Answers should never be called with out calling setparentQuestion or it
 * will cause an answer that is not answering anything
 * 
...
public class Answer extends Post {
    ...
    /**
     * Constructor creates an answer for a question without a picture or a date, Default parent ID
     * is set to null.
     * 
    ...
    /**
     * Constructor creates an answer for a question without a date, Default parent ID is set to
     * null.
     * 
     * @param text main text of the answer. (The Answer part of the Answer)
     * @param signature The user name of the user who submitted the answer.
    ...
    /**
     * Called on a answer to get the mParentID of the question that is the parent of that answer.
     * Multiple answers can have a single question but but one answer cannot have multiple questions
     * 
