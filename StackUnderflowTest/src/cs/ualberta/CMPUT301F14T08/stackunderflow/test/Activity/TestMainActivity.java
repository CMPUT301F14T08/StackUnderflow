...
public class TestMainActivity extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    public void testMainView() {
        ...
        // ma.findViewById(cs.ualberta.CMPUT301F14T08.stackunderflow.R.id.main_question_text);
        // TextView test2 = (TextView)
        // ma.getWindow().getDecorView().findViewById(cs.ualberta.CMPUT301F14T08.stackunderflow.R.id.main_question_text);
    ...
    public void testMenuSettings() {
        ...
        ActivityMonitor am = getInstrumentation().addMonitor(NewQuestionActivity.class.getName(),
                null, false);
