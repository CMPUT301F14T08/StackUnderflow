...
public class TestOnlinePostManager extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    private OnlinePostManager getOnlinePostManager() throws IllegalArgumentException,
            InstantiationException, IllegalAccessException, InvocationTargetException,
            NoSuchMethodException {
        Class[] args = {
            Context.class
        };
        Constructor<OnlinePostManager> constructor = OnlinePostManager.class
    ...
    private String insertESQuestion(OnlinePostManager mPostManager, Question newQuestion)
            throws IllegalArgumentException, InstantiationException, IllegalAccessException,
            InvocationTargetException, NoSuchMethodException {
        Class[] args = {
            Question.class
        };
        Method insertEsQuestionMethod = mPostManager.getClass().getDeclaredMethod(
                "insertEsQuestion", args);
    ...
    private String loadFromServer(OnlinePostManager mPostManager) throws IllegalArgumentException,
            InstantiationException, IllegalAccessException, InvocationTargetException,
            NoSuchMethodException {
        Method loadFromServerMethod = mPostManager.getClass().getDeclaredMethod("loadFromServer",
                null);
    ...
    private Question getESQuestion(OnlinePostManager mPostManager, Question question)
            throws NoSuchMethodException, IllegalArgumentException, IllegalAccessException,
            InvocationTargetException {
        Class[] args = {
            Question.class
        };
        Method getESQuestionMethod = mPostManager.getClass().getDeclaredMethod("getESQuestion",
                args);
    ...
    private String updateESQuestionVotes(OnlinePostManager mPostManager, Question existingQuestion,
            int voteChange) throws IllegalArgumentException, IllegalAccessException,
            InvocationTargetException, NoSuchMethodException {
        Class[] args = {
                Question.class, Integer.TYPE
        };
        Method updateEsQuestionVotesMethod = mPostManager.getClass().getDeclaredMethod(
                "updateESQuestionVotes", args);
        updateEsQuestionVotesMethod.setAccessible(true);
        Object updateEsQuestionVotesReturn = updateEsQuestionVotesMethod.invoke(mPostManager,
                existingQuestion, voteChange);
        return (String) updateEsQuestionVotesReturn;
    }

    // updateESAnswer is private, use reflection to access it here
    private String updateESAnswer(OnlinePostManager mPostManager, Question existingQuestion)
            throws IllegalArgumentException, IllegalAccessException, InvocationTargetException,
            NoSuchMethodException {
        Class[] args = {
            Question.class
        };
        Method updateESAnswerMethod = mPostManager.getClass().getDeclaredMethod("updateESAnswer",
                args);
    ...
    private String updateESAnswerVotes(OnlinePostManager mPostManager, Question existingQuestion,
            Answer existingAnswer, int voteChange) throws IllegalArgumentException,
            IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        Class[] args = {
                Question.class, Answer.class, Integer.TYPE
        };
        Method updateESAnswerVotesMethod = mPostManager.getClass().getDeclaredMethod(
                "updateESAnswerVotes", args);
        updateESAnswerVotesMethod.setAccessible(true);
        Object updateESAnswerVotesReturn = updateESAnswerVotesMethod.invoke(mPostManager,
                existingQuestion, existingAnswer, voteChange);
        return (String) updateESAnswerVotesReturn;
    }

    // addESAnswer is private, use reflection to access it here
    private String addESAnswer(OnlinePostManager mPostManager, Question existingQuestion,
            Answer existingAnswer) throws IllegalArgumentException, IllegalAccessException,
            InvocationTargetException, NoSuchMethodException {
        Class[] args = {
        ...
        Object addESAnswerReturn = addESAnswerMethod.invoke(mPostManager, existingQuestion,
                existingAnswer);
    ...
    private String deleteQuestion(Question question) {
        ...
        HttpDelete deleteRequest = new HttpDelete(
                "http://cmput301.softwareprocess.es:8080/cmput301f14t08/question/"
                        + question.getID());
        String status = null;
    ...
    public void testAddQuestion() throws IOException, IllegalArgumentException,
            IllegalAccessException, InvocationTargetException, NoSuchMethodException,
    ...
    public void testLoadQuestions() throws IOException, IllegalArgumentException,
            IllegalAccessException, InvocationTargetException, NoSuchMethodException,
    ...
    public void testRetrieveQuestion() throws IOException, IllegalArgumentException,
            IllegalAccessException, InvocationTargetException, NoSuchMethodException,
            InterruptedException, InstantiationException {
    ...
    public void testUpdateQuestionVotes() throws IOException, IllegalArgumentException,
            IllegalAccessException, InvocationTargetException, NoSuchMethodException,
            InterruptedException, InstantiationException {
    ...
    public void testUpdateAnswer() throws IOException, IllegalArgumentException,
            IllegalAccessException, InvocationTargetException, NoSuchMethodException,
            InterruptedException, InstantiationException {
    ...
    public void testUpdateAnswerVotes() throws IOException, IllegalArgumentException,
            IllegalAccessException, InvocationTargetException, NoSuchMethodException,
            InterruptedException, InstantiationException {
    ...
    // TEST: updating a question's answers
    public void testAddingAnswer() throws IOException, IllegalArgumentException,
            IllegalAccessException, InvocationTargetException, NoSuchMethodException,
            InterruptedException, InstantiationException {
