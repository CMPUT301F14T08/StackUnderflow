...
public class TestPostAdapter extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    public void testViews() {
        ...
        TextView test = (TextView) ma
                .findViewById(cs.ualberta.CMPUT301F14T08.stackunderflow.R.id.main_question_text);
        TextView test2 = (TextView) ma.getWindow().getDecorView()
                .findViewById(cs.ualberta.CMPUT301F14T08.stackunderflow.R.id.main_question_text);

        ViewAsserts.assertOnScreen(test, test2);

        test = (TextView) ma
                .findViewById(cs.ualberta.CMPUT301F14T08.stackunderflow.R.id.main_question_subtitle_text);
        test2 = (TextView) ma
                .getWindow()
                .getDecorView()
                .findViewById(
                        cs.ualberta.CMPUT301F14T08.stackunderflow.R.id.main_question_subtitle_text);

        ViewAsserts.assertOnScreen(test, test2);

        test = (TextView) ma
                .findViewById(cs.ualberta.CMPUT301F14T08.stackunderflow.R.id.main_answer_count_text);
        test2 = (TextView) ma
                .getWindow()
                .getDecorView()
                .findViewById(cs.ualberta.CMPUT301F14T08.stackunderflow.R.id.main_answer_count_text);
